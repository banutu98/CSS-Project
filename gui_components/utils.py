...
class TextInput:
    def __init__(self, initial_string="", font_family="", font_size=35, antialias=True, text_color=(0, 0, 0),
                 cursor_color=(0, 0, 1), repeat_keys_initial_ms=400, repeat_keys_interval_ms=35, max_string_length=-1,
                 clock=None):
        ...
        # Vars to make key_downs repeat after user pressed a key for some time:
    ...
    def update(self, events):
        ...
        for key in self.key_repeat_counters:
            ...
            if self.key_repeat_counters[key][0] >= self.key_repeat_initial_interval_ms:
                ...
                pg.event.post(pg.event.Event(pl.KEYDOWN, {'key': event_key, 'unicode': event_unicode}))
