...
class InstructionsScreen:
    ...
    def init_texts(self):
        ...
        text_surface = pg.font.Font(FONT_NAME, 18).render('* example 1',
                                                          True, pg.color.THECOLORS['black'])
        text_rect = text_surface.get_rect()
        text_rect.topleft = (50, 350)
        self.texts.append((text_surface, text_rect))

        text_surface = pg.font.Font(FONT_NAME, 18).render('* example 2',
                                                          True, pg.color.THECOLORS['black'])
        text_rect = text_surface.get_rect()
        text_rect.topleft = (50, 400)
        self.texts.append((text_surface, text_rect))

        text_surface = pg.font.Font(FONT_NAME, 18).render('* example 3',
                                                          True, pg.color.THECOLORS['black'])
        text_rect = text_surface.get_rect()
